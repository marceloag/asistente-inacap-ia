...
Command: npx gltfjsx@6.2.16 public/asistente.glb -o ./components/Asistentados.jsx -r public 
*/
...
export function Model(props) {
  const { nodes, materials } = useGLTF('/asistente.glb')
  return (
